...
def test_validar_comportamiento_al_eliminar_materia_con_formato_incorrecto(get_url):
    logger.info("Iniciando test MOCM031.")
    logger.debug("eliminando materia inexistente con cod @@materia$&%$")
    response = eliminar_materia(get_url, "@@materia$&%$")
