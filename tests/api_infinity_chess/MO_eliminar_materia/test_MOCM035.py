...
from src.utils.payload.payloads_materias import generar_materia_aleatoria, headers_text
...
def test_validar_comportamiento_al_eliminar_una_materia_con_header_text(get_url):
    ...
    response = eliminar_materia_con_header(get_url, payload['CODCURSO'], headers_text)
