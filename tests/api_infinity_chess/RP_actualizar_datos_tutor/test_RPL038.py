...
from src.api_infinity_chess.E2E_tutor import  crear_tutor, obtener_tutor, actualizar_tutor_celular_mayor_caracteres, eliminar_tutor
...
def test_RPL038_actualizar_tutor_con_celular_mayor_8_digitos (get_url):
    ...
    logger.info("Editar numero de celular de tutor con mas de 8 caracteres.")
    tutor_actualizado = actualizar_tutor_celular_mayor_caracteres(get_url,tutor[0])
