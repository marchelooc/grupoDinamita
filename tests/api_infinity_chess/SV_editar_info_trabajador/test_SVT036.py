import pytest
from src.utils.payload.payload_crear_trabajador import crear_payload_para_contra_vacia
...
def test_actualizar_la_contraseña_a_una_nueva_contraseña_sin_caracteres_alfanumericos (get_url):
    logger.info("Iniciando de test SVT036.")
    logger.info("Crear nuevo trabajador.")
    trabajador = crear_trabajador(get_url)
    payload = crear_payload_para_contra_vacia(trabajador)
