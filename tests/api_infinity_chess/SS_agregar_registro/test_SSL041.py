...
from src.utils.payload.payload_registro import crear_payload_sin_codigo_inscripcion

@pytest.mark.negative
def test_registro_sin_codigo_inscripcion (get_url):
     logger.info("Iniciando test SSL041.")
     payload = crear_payload_sin_codigo_inscripcion(get_url)
