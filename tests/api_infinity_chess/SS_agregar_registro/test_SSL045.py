...
from src.utils.payload.payload_registro import crear_payload_sin_codigo_estudiante

@pytest.mark.negative
def test_registro_sin_codigo_estudiante (get_url):
     logger.info("Iniciando test SSL045.")
     payload = crear_payload_sin_codigo_estudiante(get_url)
