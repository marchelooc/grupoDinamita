...
from src.utils.payload.payload_registro import crear_payload_fecha_pasada

@pytest.mark.negative
@pytest.mark.xfail(reason="Knwon issue SSBUG009: Sistema no valida fecha pasada",run=True)
def test_registro_fecha_pasada (get_url):
     logger.info("Iniciando test SSL039.")
     payload = crear_payload_fecha_pasada(get_url)
