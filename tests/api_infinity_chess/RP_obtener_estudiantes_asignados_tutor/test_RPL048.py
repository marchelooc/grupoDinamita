...
@pytest.mark.smoke
def test_RPL048_obtener_estudiantes_de_un_tutor_con_datos_completos_y_validos (get_url):
    logger.info("Iniciando Test Case RPL048")
    response = enviar_solicitud(get_url, "2024111VLASALJVQ")
