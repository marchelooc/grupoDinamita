...
@pytest.mark.xfail(reason="Knwon issue MABUG010: EL endpoint no responde correctamente cuando se elimina un grupo con id solo con caracteres especiales", run=True)
