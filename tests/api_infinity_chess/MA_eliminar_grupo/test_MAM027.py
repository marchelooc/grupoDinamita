...
@pytest.mark.xfail(reason="Knwon issue MABUG009: EL endpoint no responde correctamente cuando se elimina un grupo con id invalido con sol letras", run=True)
