...
from src.api_infinity_chess.obtener_estudiantes import enviar_solicitud , verificar_estructura_horario
...
def test_validar_estructura_de_respuesta(get_url):
    logger.info("Iniciando test SSL017.")
    ...
    logger.info("Validando estructura de horarios.")
    verificar_estructura_horario(lista_horarios)
