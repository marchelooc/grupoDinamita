import pytest
from src.api_infinity_chess.obtener_trabajadores import enviar_GET, obtener_codigo_de_trabajador_inexistente
...
def test_obtener_trabajador_con_Id_inexistente(get_url):
    ...
    response = enviar_GET (get_url, obtener_codigo_de_trabajador_inexistente())
