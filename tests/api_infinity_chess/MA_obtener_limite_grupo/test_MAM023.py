import pytest
from src.api_infinity_chess.generar_info_curso import codigo_curso, crear_grupo_limite, obtener_lista_grupos_con_limite, eliminar_grupo, verificar_limite_hay, obtener_lista_grupos, verificar_eliminacion
