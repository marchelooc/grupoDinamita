import pytest
from src.api_infinity_chess.generar_info_curso import codigo_curso, crear_grupo_limite, obtener_lista_grupos_con_limite, eliminar_grupo, verificar_limite_casi, obtener_lista_grupos, verificar_eliminacion
from src.utils.logger_config import logger

@pytest.mark.functional
def test_verificar_comportamiento_del_limite_casi(get_url):
    logger.info("Iniciando test MAM024.")
    ...
    verificar_limite_casi(lista_grupos,codigo)
