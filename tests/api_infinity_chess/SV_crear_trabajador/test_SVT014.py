...
from src.utils.payload.payload_crear_trabajador import payload_con_contraseña_invalida
...
def test_crear_trabajador_con_contraseña_sin_alfanumericos (get_url):
    logger.info("Iniciando test SVT014.")
    logger.info("Obtener datos de un trabajador con contraseña invalida.")
    payload = payload_con_contraseña_invalida()
