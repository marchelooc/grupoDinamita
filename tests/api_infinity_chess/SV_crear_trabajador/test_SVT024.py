...
from src.utils.payload.payload_crear_trabajador import payload_con_contraseña_igual_a_nombre
...
def test_crear_trabajador_con_contraseña_igual_que_el_nombre_del_usuario (get_url):
    logger.info("Iniciando test SVT024.")
    logger.info("Obtener datos de un trabajador para registrarlo en el sistema.")
    payload = payload_con_contraseña_igual_a_nombre()
